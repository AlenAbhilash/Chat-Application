...
const Inputpanel = () => {
  ...
  return (
    <div className='relative mt-3'>
      ...
      />
      <svg
        className="absolute left-3 top-1/2 transform -translate-y-1/2 h-6 w-6 text-gray-500 cursor-pointer"
        viewBox="0 0 24 24"
        fill="none"
        stroke="currentColor"
        strokeWidth="2"
      ...
      <svg className="absolute  left-[68%] md:left-[75%] top-1/2 transform -translate-y-1/2 h-6 w-6 text-gray-500 cursor-pointer" viewBox="0 0 24 24" fill="none"
        stroke="currentColor"
        strokeWidth="2"
        strokeLinecap="round"
        strokeLinejoin="round">
